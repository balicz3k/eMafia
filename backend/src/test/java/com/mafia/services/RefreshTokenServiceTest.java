...
class RefreshTokenServiceTest {
  ...
  void createRefreshToken_success() {
    ...
    when(refreshTokenRepository.countValidTokensByUser(any(User.class), any(LocalDateTime.class)))
        .thenReturn(0L);
  ...
  void refreshAccessToken_success() {
    ...
    AuthResp result = refreshTokenService.refreshAccessToken(testRefreshToken.getToken());
  ...
  void cleanupExpiredTokens_success() {
    doNothing()
        ...
        .deleteExpiredAndRevokedTokens(any(LocalDateTime.class));
